...
class TextManager:
    ...
    def get_speech_from_text(self, text):
        ...
        if option == "google":
            try:
                ...
                print(_("Some issue with google text to speech mechanism, change to some other service."
    ...
    def save_speech_result(self):
        try:
            ...
            print(_("Look it shouldn't happen but since it happened, just get to support tab of main website mate,"
