...
class AudioRecognizer:
    ...
    def recognize_from_sphinx(self, audio):
        ...
        try:
            ...
            print(_("Sphinx thinks you said ") + text)
            return text
        except self.UnknownValueError:
            print(_("Sphinx could not understand audio"))
            return False
        except self.RequestError as e:
            print(_("Sphinx error; {0}").format(e))
            return False
    ...
    def recognize_from_google(self, audio):
        try:
            ...
            print(_("Google Speech Recognition thinks you said ") + text)
            return text
        except KeyError:
            print(_("Google Recognition couldn't understand your audio with enough confidence."))
        except self.UnknownValueError:
            print(_("Google Speech Recognition could not understand audio"))
            return False
        except self.RequestError as e:
            print(_("Could not request results from Google Speech Recognition service; {0}").format(e))
            return False
    ...
    def recognize_from_google_cloud(self, audio):
        ...
        try:
            ...
            print(_("Api key not found in the config.ini file."))
            return False
        try:
            text = self.r.recognize_google_cloud(audio,
                                                 credentials_json=google_cloud_speech_credentials)
            print(_("Google Cloud Speech thinks you said ") + text)
            return text
        except self.UnknownValueError:
            print(_("Google Cloud Speech could not understand audio"))
            return False
        except self.RequestError as e:
            print(_("Could not request results from Google Cloud Speech service; {0}").format(e))
            return False
    ...
    def recognize_from_wit(self, audio):
        ...
        try:
            ...
            print(_("Wit.ai thinks you said ") + text)
            return text
        except self.UnknownValueError:
            print(_("Wit.ai could not understand audio"))
            return False
        except self.RequestError as e:
            print(_("Could not request results from Wit.ai service; {0}").format(e))
            return False
    ...
    def recognize_from_bing(self, audio):
        ...
        try:
            ...
            print(_("Microsoft Bing Voice Recognition thinks you said ") + text)
            return text
        except self.UnknownValueError:
            print(_("Microsoft Bing Voice Recognition could not understand audio"))
            return False
        except self.RequestError as e:
            print(_("Could not request results from Microsoft Bing Voice Recognition service; {0}").format(e))
            return False
    ...
    def recognize_from_houndify(self, audio):
        ...
        try:
            ...
            print(_("Houndify thinks you said ") + text)
            return text
        except self.UnknownValueError:
            print(_("Houndify could not understand audio"))
            return False
        except self.RequestError as e:
            print(_("Could not request results from Houndify service; {0}").format(e))
            return False
    ...
    def recognize_from_ibm(self, audio):
        ...
        try:
            ...
            print(_("IBM Speech to Text thinks you said ") + text)
            return text
        except self.UnknownValueError:
            print(_("IBM Speech to Text could not understand audio"))
            return False
        except self.RequestError as e:
            print(_("Could not request results from IBM Speech to Text service; {0}").format(e))
            return False
